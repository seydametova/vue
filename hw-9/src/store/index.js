...
export default new Vuex.Store({
  ...
  actions: {
    ...
    editPayment ({ commit, dispatch }, { payment }) {
      return new Promise(resolve => {
        setTimeout(() => {
  ...
  getters: {
    ...
    getChartData: state => {
      ...
      return {
        ...
        datasets: [
          {
            backgroundColor: categories.map(a => state.colors[a]),
            data: categories.map(a => statistic[a])
          }
        ]
      }
    }
